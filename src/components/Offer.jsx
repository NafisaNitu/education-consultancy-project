       ...
       <div className="mx-auto xl:pb-14 pb-6">
        ...
        <div className="container mx-auto 2xl:px-32 sm:px-16 px-6">
            <div className='md:flex justify-center items-center xl:gap-8'>
                ...
                <a href="" className="md:w-1/4 w-full xl:h-24 lg:h-28 sm:h-32 h-24 hover:box-shadow dark:bg-white dark:text-white relative after:content-[''] after:absolute after:left-0 after:bottom-0 after:w-full after:h-[4px] hover:after:bg-[#1B9FCB] hover:scale-[1.01] transition duration-300 rounded-sm py-2 flex flex-col items-center gap-3">
